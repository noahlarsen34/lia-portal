                        ...
                        <form action={uploadDocumentForSchool} className="space-y-5">
                            ...
                            <label className="block">
                                ...
                                <input
                                    ...
                                    className="mt-2 w-full rounded-md border border-zinc-300 bg-white px-3 py-3 text-sm outline-none file:mr-4 file:rounded-full file:border-8 file:bg-[#c8102e] file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-[#a70d25] focus:border-[#c8102e] focus:ring-4 focus:ring-red-100"
                                />
                            </label>
