                            ...
                            <div className="grid gap-3 sm:grid-cols-2">
                                ...
                                >
                                    ...
                                    <select
                                        ...
                                        className="h-9 rounded-md border border-zinc-300 bg-white px-2 text-sm outline-none focus:border-[#c8102e] focus:ring-4 focus:ring-red-100"
                                    >
                                    ...
                                    <button
                                        type="submit"
                                        className="h-9 rounded-md bg-[#c8102e] px-3 text-sm font-semibold text-white hover:bg-[#a70d25]"
                                    >
                                        Save
                                    </button>
                                    </div>
